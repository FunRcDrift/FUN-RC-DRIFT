...
export function header(){const el=document.createElement('header');el.className='site-header';el.innerHTML=`<nav class="nav"><a class="brand" href="index.html"><img src="assets/logo-frd.jpeg" alt=""><span>FRD Fun RC Drift</span></a><button class="mobile-menu" aria-label="Ouvrir le menu">☰</button><div class="nav-links"><a href="pilotes.html">Pilotes</a><a href="profil.html" data-auth>Mon profil</a><a href="admin.html" data-admin hidden>Administration</a><a href="connexion.html" data-guest>Connexion</a><button data-logout hidden>Déconnexion</button></div></nav>`;document.body.prepend(el);const menu=el.querySelector('.mobile-menu'),links=el.querySelector('.nav-links');menu.onclick=()=>links.classList.toggle('open');}
